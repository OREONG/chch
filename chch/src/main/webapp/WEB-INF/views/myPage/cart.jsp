...
<script>
	...
	function order() {
		...
		$('input[name=chk]:checked').each(function() {
			cart_no += $(this).next('.no').val()+",";			
		 	...
		 	location.href="purchaseStepForm.do?cart_no="+cart_no; 
		}
	...
	function chk(cart_no){
		...
		if(cart_count > 10 || cart_count < 1){
			alert('1개이상 10개이하 상품만 구매가능합니다');
			location.href="cart.do?cart_no="+cart_no;
		}
		else {
...
<body>
	<div id="board_wrap">
							...
							<div class="item">
								...
								<div style="padding-left: 20px">
									<input type="number" id="cart_count_${cart.cart_no}"
										value="${cart.cart_count }" style="width: 50px; text-align: center;">권
									<input class="del"	type="button" value="수정" onclick="chk(${cart.cart_no})">
								</div>
		...
		<div class="board_mainbtns">
			<a href="newList.do?book_kind=all&order=recent" class="board_bigorderbtn left">쇼핑
