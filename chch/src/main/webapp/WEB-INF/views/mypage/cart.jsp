...
<body>
					...
					<c:forEach var="cart" items="${cart_list }" varStatus="v">
						...
						<div class="item">
							<div class="checkbox">
								...
								<input 	type="hidden" value="${cart.cart_no}" class="no" id="cart_no_${cart.cart_no}"> 
								<input	type="hidden" value="${cart.cart_count * cart.book_price}" class="totalprice">
								<input	type="hidden" value="${cart.cart_count }" class="tot">
							</div>
							<div class="num">${k }</div>
							<div class="img">
							...
							<div class="used_subject" id="price_${v.index}"><fmt:formatNumber value="${cart.book_price }" pattern="#,###" />원</div>
							<div class="price" id="used_subject_${v.index }">
								<div><fmt:formatNumber value="${i}" pattern="#,###" />원</div>
	...
	<div class="pay">
		<div class="pay_list">
			...
			<div class="pay_body">
				<div class="pay_item">
					<div class="totalpro" id="totalpro" ><fmt:formatNumber value="${total}" pattern="#,###" type="currency"/>
					</div>
					<div>&nbsp;&nbsp;</div>
	...
	<div class="board_mainbtns">
		<a href="newBook/newList.do" class="board_bigorderbtn left">쇼핑 계속하기</a>
		
		 
		<a class="board_bigorderbtn right" onclick="order()">주문하기</a> <input
